...
//refer: http://www.java2s.com/Code/Java/Collections-Data-Structure/Topologicalsorting.htm
class Vertex {
  public char label;
...
public class TopologicalGraphSort {
  ...
  public static void main(String[] args) {
	  TopologicalGraphSort g = new TopologicalGraphSort();
    g.addVertex('A'); // 0
    g.addVertex('B'); // 1
    g.addVertex('C'); // 2
    g.addVertex('D'); // 3
